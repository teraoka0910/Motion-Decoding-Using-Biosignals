...
class EEG2DCNN(nn.Module):
    def __init__(self):
        ...
        self.model = timm.create_model('efficientvit_b1.r256_in1k', pretrained=True, in_chans=1, num_classes=3, drop_rate=0.3) #, drop_path_rate=0.15, tf_efficientnet_b0.in1k, efficientnetv2_rw_s.ra2_in1k, efficientvit_b3.r256_in1k
...
class StakeModel(nn.Module):
    def __init__(self):
        ...
        self.oned_encoder = EEG1DTemporal()
