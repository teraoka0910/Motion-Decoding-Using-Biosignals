...
class EEG2DCNN(nn.Module):
    def __init__(self, model_name):
        ...
        self.model = timm.create_model(self.model_name, pretrained=False, in_chans=1, num_classes=3)
...
class TemporalNet(nn.Module):
    def __init__(self, model_name, in_channels=50):
